...
//Tableview with alert Controller
import UIKit
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource 
{
    var list = ["Samsung S21 Ultra","Oneplus 9","iphone 13","Redmi 11","Vivo Y72","Realme S90","Motorolla TZ21","Samsung M51","Oneplus Nord3","iPhone 12"];
    var price = ["120000","60000","59000","23000","32000","21000","28000","25000","39000","64999"];
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return list.count;
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        var names =  list[indexPath.row];
        var msg = "You Select "+names;
